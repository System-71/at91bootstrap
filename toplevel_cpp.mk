...
ifeq ($(CONFIG_MANUALLY_OVERRIDE_CMDLINE), y)
CPPFLAGS += -DCMDLINE="\"$(MANUAL_LINUX_KERNEL_ARG_STRING)\""
else
CPPFLAGS += -DCMDLINE="\"$(LINUX_KERNEL_ARG_STRING)\""
endif

ifeq ($(CONFIG_LINUX_IMAGE_DUAL_BOOT), y)
CPPFLAGS += -DSCRATCH_ADDR="\"$(OF_SCRATCH_ADDRESS_STRING)\""
endif

ifeq ($(CONFIG_LCD_BOOT_SPLASH), y)
CPPFLAGS += -DBMP_OFFSET="\"$(LCD_BITMAP_OFFSET_STRING)\""
endif
