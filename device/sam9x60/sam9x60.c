...
void at91_lcdc_hw_init(void)
{
	...
	const struct pio_desc lcd_pins[] = {
		{"LCD_VSYNC",	AT91C_PIN_PC(27), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_HSYNC",	AT91C_PIN_PC(28), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_DEN",	AT91C_PIN_PC(29), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_PCLK",	AT91C_PIN_PC(30), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D0",	AT91C_PIN_PC(0), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D1",	AT91C_PIN_PC(1), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D2",	AT91C_PIN_PC(2), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D3",	AT91C_PIN_PC(3), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D4",	AT91C_PIN_PC(4), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D5",	AT91C_PIN_PC(5), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D6",	AT91C_PIN_PC(6), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D7",	AT91C_PIN_PC(7), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D8",	AT91C_PIN_PC(8), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D9",	AT91C_PIN_PC(9), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D10",	AT91C_PIN_PC(10), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D11",	AT91C_PIN_PC(11), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D12",	AT91C_PIN_PC(12), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D13",	AT91C_PIN_PC(13), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D14",	AT91C_PIN_PC(14), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D15",	AT91C_PIN_PC(15), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D16",	AT91C_PIN_PC(16), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D17",	AT91C_PIN_PC(17), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D18",	AT91C_PIN_PC(18), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D19",	AT91C_PIN_PC(19), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D20",	AT91C_PIN_PC(20), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D21",	AT91C_PIN_PC(21), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D22",	AT91C_PIN_PC(22), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
		{"LCD_D23",	AT91C_PIN_PC(23), 0, PIO_DRVSTR_ME | PIO_SLEWR_CTRL, PIO_PERIPH_A},
...
void mmu_tlb_init(unsigned int *tlb)
{
	...
	for (addr = 0x210; addr < 0x2fd; addr++)
		tlb[addr] = TTB_SECT_ADDR(addr << 20)
	                  | TTB_SECT_AP_FULL_ACCESS
	                  | TTB_SECT_DOMAIN(0xf)
	...
	/* 0x2FD00000: EBI Chip Select 1 / DDR CS - non cacheable */
	for (addr = 0x2FD; addr < 0x2FE; addr++)
		tlb[addr] = TTB_SECT_ADDR(addr << 20)
	                  | TTB_SECT_AP_FULL_ACCESS
	                  | TTB_SECT_DOMAIN(0xf)
	                  | TTB_SECT_STRONGLY_ORDERED
